...
const projects = [
  ...
  },
  {
    ...
    description:
      "NeuralViz is an AI-powered data visualization tool that transforms complex datasets into interactive charts and graphs.",
    image: PROJECT_3,
    tags: ["React", "API Integration", "Recharts", "HTML/CSS"],
    github: "https://https://github.com/rilderz/neuralviz",
