...
const projects = [
  ...
  },
  {
    id: "03",
    title: "NeuralViz",
    subtitle: "Real-Time Neural Network Training Dashboard",
    description:
      "NeuralViz is a real-time neural network training visualization dashboard that simulates and displays model training metrics like loss, accuracy, gradients, and layer activations using interactive charts. It is designed to help debug and understand machine learning models through visual insights.Also has a trading AI sample.",
    image: PROJECT_3,
    tags: ["React 19", "WebSocket", "Recharts", "TypeScript"],
    github: "https://github.com/rilderz/neuralviz",
    demo: "https://neuralviz-production.up.railway.app",
    featured: false,
    stars: 18,
  },
];
